  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4">
      <div className="relative">
        ...
        <div
          className="relative w-[340px] h-[480px] bg-gradient-to-b from-shell-highlight via-shell-primary to-shell-dark rounded-[45%_45%_42%_42%] shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_2px_0_rgba(255,255,255,0.3),inset_0_-4px_8px_rgba(0,0,0,0.1)] flex flex-col items-center pt-10 pb-4"
        >
          {/* Brand text */}
          ...
          {/* Screen bezel */}
          <div className="relative w-[260px] h-[230px] bg-[#2a2a2a] rounded-lg p-2 shadow-[inset_0_2px_8px_rgba(0,0,0,0.6)]">
            {/* LCD screen */}
